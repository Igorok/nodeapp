        ...
        .then(() => {
            ...
            router.get('/post-detail/:postId', function(req, res, next) {
                let opts = {
                    ...
                    variables: {
                        postId: req.params.postId ? req.params.postId.toString() : null,
                    },
                    title: 'Express Post'
                };
                res.render('simple_view', opts);
            ...
            router.get('/my-post-detail/:blogId/:postId', function(req, res, next) {
                let opts = {
                    javascript: ['my_post_detail'],
                    variables: {
                        blogId: req.params.blogId ? req.params.blogId.toString() : null,
                        postId: req.params.postId ? req.params.postId.toString() : null,
                    },
                    title: 'Express Post'
                };
